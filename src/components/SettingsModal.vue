...
onMounted(async () => {
    await loadSettings();
    applySettingsToDOM();
    watch(() => props.theme, updateThemeIcons);
    watch(settings, () => {
        ...
        <div id="app-container" @click.stop>
            ...
            <div id="settings-content">
                <div class="settings-container">
                    ...
                    <AiModelsSettings 
                        v-model:models="settings.aiModels"
                        v-model:activeChatModel="settings.activeChatModel"
                        v-model:activeTranslateModel="settings.activeTranslateModel"
                        @show-notification="showNotification"
                    />

                    <PromptSettings
                        v-model:chatPrompt="settings.chatPrompt"
                        v-model:translationPrompt="settings.translationPrompt"
                    />
...
${selectedConfigFile}`"
                ...
                @cancel="showImportConfirmDialog = false"
            />
        </div>
    </div>
</template>
